...
/**
 * 作为服务端的事件监听器，监听客户端的连接和客户端的发送的数据以及及时响应
 */
abstract class ReactorThread extends Thread{
    ...
    public ReactorThread() throws IOException {
        ...
        System.out.println ("-----reactorThread="+selector.toString ());
    }

    /**
     * 服务端的注册
     * 注册两次需要用到：服务端启动注册到select和接受客户端连接注册accept事件
