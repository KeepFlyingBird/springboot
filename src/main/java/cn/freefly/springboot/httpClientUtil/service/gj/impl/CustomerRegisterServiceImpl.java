...
//            return BaseResponse.createBaseResponse(ResponseCode.CHANNEL_CUSTOMER_REGISTER_NOT_APPLY);
//        }
...
//            return BaseResponse.createBaseResponse(ResponseCode.CHANNEL_CUSTOMER_REGISTER_ATTACH_NOT_EXIST);
//        }
//        // 查询资方配置信息
//        GjFundServerConfig fundService = pathConfigService.findGjFundService(applicationName);
//        BaseResponse response = gjHttpClients.post(fundService.getSaveApiUrl(), customerRegisterRequest, applicationName, fundService);
